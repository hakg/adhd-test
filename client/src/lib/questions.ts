...
export const questions: Question[] = [
  {
    id: 1,
    category: "주의력 부족",
    text: "업무나 다른 활동을 할 때 세부사항에 주의를 기울이지 못하거나 부주의한 실수를 자주 한다",
    type: "inattention"
  },
  {
    id: 2,
    category: "주의력 부족",
    text: "업무나 여가 활동에 지속적으로 주의를 집중하는데 어려움이 있다",
    type: "inattention"
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    category: "주의력 부족",
    text: "지시를 완전히 따르지 못하고, 학업이나 업무를 끝내지 못한다",
    type: "inattention"
  },
  {
    id: 5,
    category: "주의력 부족",
    text: "과제와 활동을 체계화하는데 어려움이 있다",
    type: "inattention"
  },
  {
    id: 6,
    category: "주의력 부족",
    text: "지속적인 정신적 노력이 요구되는 과제를 피하거나 싫어한다",
    type: "inattention"
  },
  {
    id: 7,
    category: "주의력 부족",
    text: "활동이나 과제에 필요한 물건들을 잃어버린다",
    type: "inattention"
  },
  {
    id: 8,
  ...
  },
  {
    id: 11,
    category: "과다행동",
    text: "앉아 있어야 하는 상황에서 자리를 떠난다",
    type: "hyperactivity"
  },
  {
    id: 12,
    category: "과다행동",
    text: "부적절한 상황에서 뛰어다니거나 기어오른다",
    type: "hyperactivity"
  },
  {
    id: 13,
...
export function getResultInterpretation(totalScore: number) {
  if (totalScore >= 36) {
    return {
      level: "고위험군",
      description: "ADHD 증상이 심각한 수준으로 나타났습니다. 일상생활에 상당한 영향을 미칠 수 있는 상태입니다.",
      recommendations: [
        "즉시 정신건강의학과 전문의 상담을 받으시기 바랍니다",
        "정확한 진단과 치료 계획 수립이 필요합니다",
        "약물치료 및 인지행동치료를 고려해볼 수 있습니다",
        "일상생활 관리 전략에 대해 전문가와 상의하세요"
      ]
    };
  } else if (totalScore >= 24) {
    return {
      level: "중등도 위험군",
      description: "ADHD 증상이 일상생활에 영향을 줄 수 있는 수준으로 나타났습니다.",
      recommendations: [
        "정신건강의학과 전문의 상담을 받아보시기 바랍니다",
        "정확한 진단을 위한 추가 검사가 필요할 수 있습니다",
        "일상생활 관리 방법에 대해 전문가와 상의하세요",
        "스트레스 관리와 규칙적인 생활습관을 유지하세요"
      ]
    };
  } else if (totalScore >= 12) {
    return {
      level: "경미한 위험군",
      description: "일부 ADHD 증상이 관찰되지만 경미한 수준입니다.",
      recommendations: [
    ...
    return {
      level: "정상 범위",
      description: "현재 ADHD 증상이 거의 나타나지 않는 정상 범위입니다.",
      recommendations: [
        "현재 상태를 잘 유지하시기 바랍니다",
